...
#ifndef __VGKEXCEPTION_H__
#define __VGKEXCEPTION_H__
...
namespace vgKernel {
	...
	/**
		...
		@see    
	*/
	class VGK_EXPORT  Exception : public std::exception
    {
    protected:
        long line;
	...
	*/
	...
	class   VGK_EXPORT UnimplementedException : public Exception 
	{
	public:
	...
	class   VGK_EXPORT FileNotFoundException : public Exception
	{
	public:
	...
	class   VGK_EXPORT IOException : public Exception
	{
	public:
	...
	class   VGK_EXPORT InvalidStateException : public Exception
	{
	public:
	...
	class  VGK_EXPORT  InvalidParametersException : public Exception
	{
	public:
	...
	class  VGK_EXPORT  ItemIdentityException : public Exception
	{
	public:
	...
	class  VGK_EXPORT  InternalErrorException : public Exception
	{
	public:
	...
	class  VGK_EXPORT  RenderingAPIException : public Exception
	{
	public:
	...
	class  VGK_EXPORT  RuntimeAssertionException : public Exception
	{
	public:
...
#define VGK_EXCEPT(num, description, src) throw vgKernel::ExceptionFactory::create( \
	vgKernel::ExceptionCodeType<num>(), description, src, __FILE__, __LINE__ );



#endif // end of __VGKEXCEPTION_H__