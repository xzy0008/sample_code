...
#ifndef __VGDLGBRIGHTFLOOR_H__
#define __VGDLGBRIGHTFLOOR_H__
...
#include <resource.h>
class  VGDEP_EXPORT DlgBrightfloor : public CDialog
{
// Construction
public:
	...
	DlgBrightfloor( vgMod::ModItemPtrVec& node_list , CWnd* pParent = NULL);
	vgMod::ModItemPtrVec _nodeList;
	vgMod::BrightfloorNode* _currentNode;
...
#endif // end of __VGDLGBRIGHTFLOOR_H__