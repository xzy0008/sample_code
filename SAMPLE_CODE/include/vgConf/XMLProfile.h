...
public:
	...
	CWTLString GetProfileString(LPCTSTR lpszSection, 
								LPCTSTR lpszEntry,
								LPCTSTR lpszDefault);
...
public:
	...
	CWTLString GetKey(LPCTSTR lpszSectionName, 
					  LPCTSTR lpszKeyName, 
					  LPCTSTR lpszDefault);
...
public:
	...
	CWTLString		m_strProfileFile;	// profile file path
	...
	CWTLString		m_strProfileTag;
	CWTLString		m_strSectionTag;
	CWTLString		m_strKeyTag;
	CWTLString		m_strNameTag;		// used for both sections and keys
	CWTLString		m_strValueTag;
	CWTLString		m_strReadOnlyTag;
