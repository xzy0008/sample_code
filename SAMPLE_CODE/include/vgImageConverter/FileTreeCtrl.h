...
public:
	enum CheckState{ 
		...
		FILE_CHECKSTATE, 
		CHILD_FILE_FOLDER,
		CHILD_ALLFILES_FOLDER, 
		DISABLED, 
		NOSTATE,
		CHILD_NOFILE_ALLFOLDERS = 12, 
		CHILD_FILE_ALLFOLDERS=14, 
		CHILD_ALL};
...
public:
	...
	void setCheckState( const bool& check_state )
	{
		this->m_bUseCheckState = check_state ;
	}
