...
enum ExTreeCmdHandler {
	...
	NID_ATTRIBUTE_LIST,                       //2010.05.04 KingHJ
...
class  VGUI_EXPORT CEditTreeTracker : public CRectTracker {
...
class  VGUI_EXPORT CEditTreeCtrlEx : public CEditTreeCtrl
{
	protected:
...
protected:
	...
	bool    DoShowAttributeList(HTREEITEM);
...
class  VGUI_EXPORT CDragDataEx : public CDragData {
	public:
...
class   VGUI_EXPORT vgSubEntry : public vgRootEntry
{
public:
