...
class  VGDEP_EXPORT CEditTreeTracker : public CRectTracker {
...
class  VGDEP_EXPORT CEditTreeCtrlEx : public CEditTreeCtrl
{
	protected:
...
class  VGDEP_EXPORT CDragDataEx : public CDragData {
	public:
...
class   VGDEP_EXPORT vgSubEntry : public vgRootEntry
{
public:
