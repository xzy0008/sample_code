...
#ifndef __VGFMATRIX4_H__
#define __VGFMATRIX4_H__
    ...
    */
    ...
    public:
        ...
        */
		...
		inline Matrix4( Real* transposedMat )
		{
			//for ( int i = 0 ; i < 16 ; i++ )
			//{
			//	_m[i] = M[i];
			//}
			this->createFromTranspose( transposedMat );
		}
		...
		inline void createFromTranspose( const Real* const transposedMat )
		{
			m[0][0] = transposedMat[0];
			m[0][1] = transposedMat[4];
			m[0][2] = transposedMat[8];
			m[0][3] = transposedMat[12];
			m[1][0] = transposedMat[1];
			m[1][1] = transposedMat[5];
			m[1][2] = transposedMat[9];
			m[1][3] = transposedMat[13];
			m[2][0] = transposedMat[2];
			m[2][1] = transposedMat[6];
			m[2][2] = transposedMat[10];
			m[2][3] = transposedMat[14];
			m[3][0] = transposedMat[3];
			m[3][1] = transposedMat[7];
			m[3][2] = transposedMat[11];
			m[3][3] = transposedMat[15];
		}
        ...
        */
		...
		inline Matrix4 transposedCopy(void) const
		{
