...
namespace vgCore {
	...
	GLenum  MirrorGpuProgram::FaceTarget[6] = {  
	...
	char *MirrorGpuProgram::vertex_source = "\
	...
	char *MirrorGpuProgram::pixel_source = "\
				void main(\
					float2 in_texCoord : TEXCOORD0,\
					float3 R		: TEXCOORD1 ,\
					float4 in_color  :	COLOR,\
	...
	bool MirrorGpuProgram::buildFaceTextureUsingGDI( const string& filename , GLenum target )
	{
...
// 		}
		...
		*/
		...
		//----------------------------------------------------------------
		GLuint MirrorGpuProgram::buildCubeMapID( const StringVector& strVec )
		{
			GLuint textureID = 0;
		...
		//----------------------------------------------------------------
		GLuint MirrorGpuProgram::buildNormalMapID( const String& normalmap , 
			const float& bump )
		{
		...
		//----------------------------------------------------------------
		GLuint MirrorGpuProgram::buildDecalMapID( const String& decalmap )
		{
			GLuint textureID = 0;
		...
		void MirrorGpuProgram::useBindBegin()
		{
		...
		void MirrorGpuProgram::useBindEnd()
		{
