...
DocType doctypes[CMAX_IMAGE_FORMATS + 1] =
{
	{ -1, TRUE, TRUE, "Supported files", "*.vgtr;*.bmp;*.gif;*.jpg;*.jpeg;*.png;*.ico;*.tif;*.tiff;*.tga;*.pcx;*.wbmp;*.wmf;*.emf;*.j2k;*.jp2;*.jbg;*.j2c;*.jpc;*.pgx;*.pnm;*.pgm;*.ppm;*.ras" },
#if CXIMAGE_SUPPORT_TGA
	{ CXIMAGE_FORMAT_TGA, TRUE, TRUE, "VGTR files", "*.tga;*.vgtr" },
#endif
