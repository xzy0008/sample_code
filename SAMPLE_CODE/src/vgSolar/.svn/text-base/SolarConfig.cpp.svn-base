// SolarConfig.cpp : implementation file
//
...
IMPLEMENT_DYNAMIC(CSolarConfig, CDialog)

CSolarConfig::CSolarConfig(vgSolar::DateTimeAndLocation* loc , 
							   CWnd* pParent /*=NULL*/)
							   : CDialog(CSolarConfig::IDD, pParent)
							   , _year( loc->getYear() )
							   , _month( loc->getMonth() )
							   , _day( loc->getDay() )
							   , _hour( loc->getHour() )
...
CSolarConfig::~CSolarConfig()
{
}

void CSolarConfig::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CSolarConfig, CDialog)
END_MESSAGE_MAP()

BOOL CSolarConfig::OnInitDialog()
{
