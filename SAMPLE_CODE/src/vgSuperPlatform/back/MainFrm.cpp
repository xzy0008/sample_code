...
CMainFrame::CMainFrame()//:tab(new int(1))
{
	...
	m_nAppLook = NID_VIEW_APPLOOK_2003;
}
...
//	lstBasicCommands.AddTail (NID_VIEW_HELLO);
	...
	if (!m_wndToolBar.CreateEx(this, TBSTYLE_FLAT, WS_CHILD | WS_VISIBLE | CBRS_TOP
		...
		!m_wndToolBar.LoadToolBar(NIDR_MAINFRAME, 0, 0, FALSE, 0, 0, uiToolbarHotID))
	{
...
// 	pStatusBar->SetPaneStyle (nStatusIcon, SBPS_NOBORDERS);
// 	pStatusBar->SetPaneStyle (nStatusAnimation, SBPS_NOBORDERS);
// 	pStatusBar->SetPaneStyle (nStatusInfo, SBPS_STRETCH | SBPS_NOBORDERS);
// 	pStatusBar->SetPaneWidth (nStatusProgress, 80);
	pStatusBar->EnablePaneDoubleClick ();
...
//  	pStatusBar->SetPaneWidth (nStatusProgress, 80);
//  
//  	//pStatusBar->SetPaneText(nStatusLabel, "帧速");
// 	pStatusBar->EnablePaneDoubleClick ();
	...
	EnableControlBarMenu (	
		...
		NID_VIEW_TOOLBARS);	// Menu items with this ID will be replaced by
							// toolbars menu
