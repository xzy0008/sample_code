...
int CRollupCtrl::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	pwndHide = new CDispColorDlg;
 	...
 	pwndHide->Create(MAKEINTRESOURCE(NIDD_MESH1), this);
 	this->InsertPage("操作", pwndHide );


	pPropDlg = new CDispPropDlg;
	pPropDlg->Create(MAKEINTRESOURCE(NIDD_MESH2), this);
	this->InsertPage("点选", pPropDlg );
	
	//TRACE("Roll up Create \n");
	return 0;
}
