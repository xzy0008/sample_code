...
vgTestNode1::vgTestNode1(String name):vgBaseEntry( 
	vgKernel::UniqueIDFactory::getUniqueID() , name),
									  m_sCaption("默认物体"),
									  m_sOptionOne("选项1")
{
	m_posX = 0.f;
