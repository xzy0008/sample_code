...
//
//#include <vgModel/vgmoShadowMetaFace.h>
//#include <vgModel/vgmoModelRenderWayVertexArray.h>
//#include <vgModel/vgmoModelDataPlus.h>
//
//
//namespace vgModel {
//	
...
//	}
//	//----------------------------------------------------------------
//	void ShadowMetaFace::setFromMetaFaceStruct( ModelRenderWayVertexArray* vaway , 
...
//		assert( _vaway == NULL );
//
//		//assert( vaway->_sizeOfVertexElements == sizeof( VmdVertexElement1 ) );
//
//		if ( vaway->_sizeOfVertexElements == sizeof( VmdVertexElement1 ) )
//		{
//			VmdVertexElement1* elements = 
//				(VmdVertexElement1*)vaway->_vertexElements;
//
//			_vaway = vaway;
...
//		else 
//		{
//			assert( vaway->_sizeOfVertexElements == sizeof( VmdVertexElement2 ));
//
//			VmdVertexElement2* elements = 
//				(VmdVertexElement2*)vaway->_vertexElements;
//
//			_vaway = vaway;
//			assert( metaface != NULL );
//			_metaFaceStruct = metaface;
...
//		}
//
//		assert( _vaway->_sizeOfVertexElements == sizeof( VmdVertexElement1 ) );
//
//		VmdVertexElement1* elements = 
//			(VmdVertexElement1*)_vaway->_vertexElements;
//
...
//		}
//
//		assert( _vaway->_sizeOfVertexElements == sizeof( VmdVertexElement2 ) );
//
//		VmdVertexElement2* elements = 
//			(VmdVertexElement2*)_vaway->_vertexElements;
//
//		const int& p1v =  sw_face_data->_faceindex->_point0;
//
//		const int& p2v = sw_face_data->_faceindex->_point1;
...
//	{
//		if ( _vaway->_sizeOfVertexElements == sizeof( VmdVertexElement1 ) )
//		{
//			//------------------------------------------
//			// 遍历每个面，计算临边
//			//------------------------------------------
