...
//=============================================================================
CWTLString CXmlElement::GetValue(LPCTSTR attribute)
//=============================================================================
{
	CWTLString strAttribute(attribute);
	CWTLString ret = m_strAttributes;
...
//=============================================================================
{
	...
	CWTLString strTag = _T("");
	CWTLString strData = _T("");
	CWTLString strResult = _T("");
...
//
int CXmlParser::ValidateTag(CWTLString &strTag, CWTLString &strResult)
//=============================================================================
{
	strResult = _T("");
...
//=============================================================================
CWTLString CXmlParser::Generate(BOOL bUnicode)
//=============================================================================
{
...
//=============================================================================
BOOL CXmlParser::CreateTag(CXmlElement *pElement, CWTLString& strResult)
//=============================================================================
{
...
//=============================================================================
{
	...
	CWTLString strXML = Generate(bFileIsUnicode);
	TRACE(_T("strXML=<%s>\n"), strXML);
