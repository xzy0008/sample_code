...
BEGIN_MESSAGE_MAP(TabOne, CDialog)
	...
	ON_NOTIFY(TVN_SELCHANGED, IDC_TREE1, &TabOne::OnTvnSelchangedTree1)
	ON_WM_DESTROY()
	ON_NOTIFY(TVN_BEGINDRAG, IDC_TREE1, &TabOne::OnTvnBegindragTree1)
	ON_NOTIFY(NM_RCLICK, IDC_TREE1, &TabOne::OnNMRclickTree1)
	ON_WM_MOUSEMOVE()
END_MESSAGE_MAP()
