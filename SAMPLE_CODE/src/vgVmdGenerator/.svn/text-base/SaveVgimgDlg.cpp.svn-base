...
//#include <vgModel/vgmFileWriterModToVmd.h>
...
void CSaveVgimgDlg::OnBnClickedImportFiles()
{
	...
	for ( ; iter != iter_end ; ++ iter )
	{
		...
		String ddsfilename = 
			basename.substr( 0 , basename.find_last_of(".") ) + ".vmd";
...
void CSaveVgimgDlg::OnBnClickedDdsSave()
{
	...
	//assert(0);
#if 1
	vgModel::FileWriterModToVmd mwriter;

	mwriter.registerProcessObs( this );

	bool ret = mwriter.writeToVmdFromStringPairs(
		*pResult , 0.0f , 0.0f , 
